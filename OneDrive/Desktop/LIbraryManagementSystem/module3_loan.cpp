...
void loanMenu(vector<Loan>& loans, vector<Book>& books,
    ...
    do {
        ...
        switch (choice) {
            case 1:
                // TODO: issueLoan(loans, books, members, memID, bookID);
                cout << "\n[Module 3] issueLoan() not implemented yet.";
                pressEnterToContinue();
                break;
            case 2:
                // TODO: renewLoan(loans, ...);
                cout << "\n[Module 3] renewLoan() not implemented yet.";
                pressEnterToContinue();
                break;
            case 3:
                // TODO: returnBook(loans, books, members, fines...);
            ...
            case 5:
                ...
                break;
            case 6:
                // TODO: displayActiveLoans(loans, books, members);
